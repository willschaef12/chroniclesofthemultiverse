...
const story = {
  ...
  scenes: [
    ...
    {
      text: "You have chosen Flash! Speed is on your side.",
      choices: [
        { text: "Seek Star-Lord's help", nextScene: 5 },
        { text: "Face the enemy alone", nextScene: 6 },
      ],
    },
    {
      text: "Loki leads the charge with cunning and magic.",
      choices: [
        { text: "Enlist Scarlet Witch", nextScene: 7 },
        { text: "Find Silver Surfer", nextScene: 8 },
      ],
    },
    {
      text: "Star-Lord joins you, bringing his gadgets and wit.",
      choices: [
        { text: "Form a team", nextScene: 9 },
        { text: "Go solo", nextScene: 6 },
      ],
    },
  ],
};
